...
while running:
    ...
    for a, b in itertools.combinations(objects, 2):
        ...
        if c.overlap > 0:
            vbefore = ((c.a.vel+c.a.avel*(c.point()-c.a.pos+c.a.pos).rotate(90)).dot(c.normal)
                        - (c.b.vel+c.b.avel*(c.point()-c.b.pos+c.b.pos).rotate(90)).dot(c.normal))
            c.resolve()
            vafter = ((c.a.vel+c.a.avel*(c.point()-c.a.pos+c.a.pos).rotate(90)).dot(c.normal)
                        - (c.b.vel+c.b.avel*(c.point()-c.b.pos+c.b.pos).rotate(90)).dot(c.normal))
            print(f"before:{vbefore}, after:{vafter}, ratio:{vafter/vbefore}, restitution:{restitution}")
            print(a.vel, b.vel)
    ...
    for o in objects:
        o.draw(window)
    if c:
        pygame.draw.circle(window, (0,0,0), c.point(), 10)
