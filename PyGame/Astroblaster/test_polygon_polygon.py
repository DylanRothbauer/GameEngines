...
objects.append(Polygon(mass=math.inf, local_points=local_points, pos=[250,150], color=[255,0,0], avel=0, normals_length=50))
polygon = Polygon(mass=1, local_points=[(0,-100), (75,-25), (-25,25)], color=[0,0,255], width=2, normals_length=50)
